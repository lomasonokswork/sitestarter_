    ...
    if (empty($errors)) {
      ...
      if ($stmt->fetch()) {
        ...
        if ($stmt->execute()) {
          ...
          $errors[] = "DB error: Unable to create account";
        }
      }
    }
  }
  ...
  <div class="main">
    <div class="navbar">
      ...
      <div class="nav_right">
        ...
        <?php else: ?>
          <a class="link" href="profile.php"><i class="fas fa-user"></i><?php if (isset($_SESSION['username'])) {
            echo "Profile";
          }
          ; ?></a>
        <?php endif; ?>
      ...
      <div class="login_L">
        ...
        <form method="POST" class="form signup-form" novalidate>
          ...
          <div class="form-group">
            ...
            <input id="signup-verify" name="verify" type="password" autocomplete="new-password" required />
          </div>
