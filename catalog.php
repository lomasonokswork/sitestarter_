      ...
      <div class="filters">
        <form method="GET" action="catalog.php">
          ...
          <div class="filter-section">
            ...
            <div class="filter-options">
              <div class="filter-option">
                <input type="radio" id="type-all" name="type" value="" <?php if($filterType == '') echo 'checked'; ?>>
                <label for="type-all">All</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="type-frontend" name="type" value="Frontend" <?php if($filterType == 'Frontend') echo 'checked'; ?>>
                <label for="type-frontend">Frontend</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="type-fullstack" name="type" value="Fullstack" <?php if($filterType == 'Fullstack') echo 'checked'; ?>>
          ...
          <div class="filter-section">
            ...
            <div class="filter-options">
              <div class="filter-option">
                <input type="radio" id="feature-all" name="feature" value="" <?php if($filterFeature == '') echo 'checked'; ?>>
                <label for="feature-all">All</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="feature-api" name="feature" value="API" <?php if($filterFeature == 'API') echo 'checked'; ?>>
                <label for="feature-api">API</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="feature-database" name="feature" value="Database" <?php if($filterFeature == 'Database') echo 'checked'; ?>>
                <label for="feature-database">Database</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="feature-auth" name="feature" value="Authentication" <?php if($filterFeature == 'Authentication') echo 'checked'; ?>>
                <label for="feature-auth">Authentication</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="feature-payment" name="feature" value="Payment" <?php if($filterFeature == 'Payment') echo 'checked'; ?>>
                <label for="feature-payment">Payment</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="feature-realtime" name="feature" value="Real-time" <?php if($filterFeature == 'Real-time') echo 'checked'; ?>>
                <label for="feature-realtime">Real-time</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="feature-analytics" name="feature" value="Analytics" <?php if($filterFeature == 'Analytics') echo 'checked'; ?>>
          ...
          <div class="filter-section">
            ...
            <div class="filter-options">
              <div class="filter-option">
                <input type="radio" id="category-all" name="category" value="" <?php if($filterCategory == '') echo 'checked'; ?>>
                <label for="category-all">All</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="category-personal" name="category" value="Personal" <?php if($filterCategory == 'Personal') echo 'checked'; ?>>
                <label for="category-personal">Personal</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="category-creative" name="category" value="Creative" <?php if($filterCategory == 'Creative') echo 'checked'; ?>>
                <label for="category-creative">Creative</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="category-productivity" name="category" value="Productivity" <?php if($filterCategory == 'Productivity') echo 'checked'; ?>>
                <label for="category-productivity">Productivity</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="category-ecommerce" name="category" value="E-commerce" <?php if($filterCategory == 'E-commerce') echo 'checked'; ?>>
                <label for="category-ecommerce">E-commerce</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="category-lifestyle" name="category" value="Lifestyle" <?php if($filterCategory == 'Lifestyle') echo 'checked'; ?>>
                <label for="category-lifestyle">Lifestyle</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="category-health" name="category" value="Health" <?php if($filterCategory == 'Health') echo 'checked'; ?>>
                <label for="category-health">Health</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="category-education" name="category" value="Education" <?php if($filterCategory == 'Education') echo 'checked'; ?>>
                <label for="category-education">Education</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="category-finance" name="category" value="Finance" <?php if($filterCategory == 'Finance') echo 'checked'; ?>>
                <label for="category-finance">Finance</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="category-entertainment" name="category" value="Entertainment" <?php if($filterCategory == 'Entertainment') echo 'checked'; ?>>
          ...
          <div class="filter-section">
            ...
            <div class="filter-options">
              <div class="filter-option">
                <input type="radio" id="difficulty-all" name="difficulty" value="" <?php if($filterDifficulty == '') echo 'checked'; ?>>
                <label for="difficulty-all">All</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="difficulty-beginner" name="difficulty" value="Beginner" <?php if($filterDifficulty == 'Beginner') echo 'checked'; ?>>
                <label for="difficulty-beginner">Beginner</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="difficulty-intermediate" name="difficulty" value="Intermediate" <?php if($filterDifficulty == 'Intermediate') echo 'checked'; ?>>
                <label for="difficulty-intermediate">Intermediate</label>
              </div>
              <div class="filter-option">
                <input type="radio" id="difficulty-advanced" name="difficulty" value="Advanced" <?php if($filterDifficulty == 'Advanced') echo 'checked'; ?>>
