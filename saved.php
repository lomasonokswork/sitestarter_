...
$savedProjects = getSavedProjects($_SESSION['user_id']);
...
$savedProjectsList = array_filter($projects, function($project) use ($savedProjects) {
    return in_array($project['name'], $savedProjects);
});

$filteredProjects = [];
foreach ($savedProjectsList as $project) {
  $show = true;
  ...
  <div class="main">
    <div class="navbar">
        ...
        <div class="nav_mid">
          ...
          <a class="link active" href="saved.php">Saved</a>
        </div>
        <div class="nav_right">
      ...
      <div class="filters">
        <form method="GET" action="saved.php">
          ...
          <div class="filter-actions">
            ...
            <a href="saved.php" class="filter-btn clear-btn">Clear</a>
          </div>
        </form>
      </div>
